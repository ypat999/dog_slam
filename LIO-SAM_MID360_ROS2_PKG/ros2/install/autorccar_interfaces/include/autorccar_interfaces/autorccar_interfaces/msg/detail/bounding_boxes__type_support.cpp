...
{
  new (message_memory) autorccar_interfaces::msg::BoundingBoxes(_init);
}

void BoundingBoxes_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autorccar_interfaces::msg::BoundingBoxes *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBoxes_message_member_array[2] = {
  {
    ...
    offsetof(autorccar_interfaces::msg::BoundingBoxes, num),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autorccar_interfaces::msg::BoundingBoxes, bounding_boxes),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBoxes_message_members = {
  ...
  2,  // number of fields
  sizeof(autorccar_interfaces::msg::BoundingBoxes),
...
{
  return &::autorccar_interfaces::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autorccar_interfaces, msg, BoundingBoxes)() {
  return &::autorccar_interfaces::msg::rosidl_typesupport_introspection_cpp::BoundingBoxes_message_type_support_handle;
}
