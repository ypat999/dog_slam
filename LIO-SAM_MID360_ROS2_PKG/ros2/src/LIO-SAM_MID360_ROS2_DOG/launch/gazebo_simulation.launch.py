...
def generate_launch_description():
    ...
    # Robot description
    robot_description_path = os.path.join(pkg_lio_sam, 'urdf', 'robot.urdf')
    ...
    spawn_entity_node = Node(
        ...
        name='spawn_entity',
        output='screen',
        arguments=['-entity', 'lio_sam_robot', '-topic', 'robot_description', '-x', '0', '-y', '0', '-z', '0.3']
    )
    
    # RViz2
    rviz_config_path = os.path.join(pkg_lio_sam, 'config', 'gazebo_rviz.rviz')
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
