...
class ImuProcess {
   ...
   private:
    ...
    std::vector<faster_lio::msg::Pose6D> IMUpose_;
...
void ImuProcess::UndistortPcl(const common::MeasureGroup &meas, esekfom::esekf<state_ikfom, 12, input_ikfom> &kf_state,
    ...
    IMUpose_.clear();
    faster_lio::msg::Pose6D pose;
    pose.offset_time = 0.0;
    pose.acc[0] = acc_s_last_[0]; pose.acc[1] = acc_s_last_[1]; pose.acc[2] = acc_s_last_[2];
    pose.gyr[0] = angvel_last_[0]; pose.gyr[1] = angvel_last_[1]; pose.gyr[2] = angvel_last_[2];
    pose.vel[0] = imu_state.vel[0]; pose.vel[1] = imu_state.vel[1]; pose.vel[2] = imu_state.vel[2];
    pose.pos[0] = imu_state.pos[0]; pose.pos[1] = imu_state.pos[1]; pose.pos[2] = imu_state.pos[2];
    pose.rot[0] = imu_state.rot.toRotationMatrix()(0,0); pose.rot[1] = imu_state.rot.toRotationMatrix()(0,1); pose.rot[2] = imu_state.rot.toRotationMatrix()(0,2);
    pose.rot[3] = imu_state.rot.toRotationMatrix()(1,0); pose.rot[4] = imu_state.rot.toRotationMatrix()(1,1); pose.rot[5] = imu_state.rot.toRotationMatrix()(1,2);
    pose.rot[6] = imu_state.rot.toRotationMatrix()(2,0); pose.rot[7] = imu_state.rot.toRotationMatrix()(2,1); pose.rot[8] = imu_state.rot.toRotationMatrix()(2,2);
    IMUpose_.push_back(pose);
