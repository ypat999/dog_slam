...
class LaserMapping {
   public:
    ...
    /// init with ros
    bool InitROS(rclcpp::Node::SharedPtr nh);
    ...
    void LivoxPCLCallBack(livox_ros_driver2::msg::CustomMsg::SharedPtr msg);
   ...
   private:
    ...
    void SubAndPubToROS(rclcpp::Node::SharedPtr nh);
    bool LoadParams(rclcpp::Node::SharedPtr nh);
