...
TRAJECTORY_BUILDER_3D.missing_data_ray_length = 20.
...
TRAJECTORY_BUILDER_3D.submaps.grid.high_resolution = 0.1
TRAJECTORY_BUILDER_3D.submaps.grid.low_resolution = 0.45
...
MAP_BUILDER.publish_submap = true
